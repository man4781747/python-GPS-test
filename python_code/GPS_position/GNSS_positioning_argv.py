...
class Satellite_Calculate:
    ...
    def get_sate_position(self,Ay_M0,Ay_dn,e,Ay_sqrta,Ay_i0,Ay_omg0,w,Ay_odot,Ay_idot,Ay_cuc,Ay_cus,Ay_crc,Ay_crs,Ay_cic,Ay_cis,Ay_toe,F_time_chose_sec_int,F_time_chose_sec_decimal,
                                        F_gpsweektime_fst,Ay_delta_t_sv,Ay_pseudo_range,af0,af1,af2,toc):
        '''
        此為上課版本
        (Ay_xk,Ay_yk,Ay_zk) = Mobj_sate_cal.get_sate_position(M0,dn,e,sqrta,i0,omg0,w,odot,idot,
                                        cuc,cus,crc,crs,cic,cis,toe,
        ...
        Ay_tk_int = Ay_time_int - Ay_toe.astype('int')
        Ay_tk_decimal = Ay_time_decimal - (Ay_toe-Ay_toe.astype('int'))
        
        Ay_tk = Ay_tk_int +  Ay_tk_decimal      # (s)
        
        
#        print(Ay_time_int+Ay_time_decimal)
#        print(Ay_toe)
#        print('{0:1.15f}'.format((Ay_pseudo_range/self.F_c)[6] ))
#        print('{0:1.15f}'.format(Ay_tk[6]))
...
#        print(self.Ay_Ek[6])
        ...
        Ay_tk_fix_time_int = Ay_time_int - Ay_toe.astype('int')
        Ay_tk_fix_time_decimal = Ay_time_decimal - (Ay_toe-Ay_toe.astype('int'))
        
        Ay_tk_fix_time = Ay_tk_fix_time_int +  Ay_tk_fix_time_decimal  
        get_sate_clock_error_fix = af0+af1*Ay_tk_fix_time+af2*Ay_tk_fix_time**2-2*(self.F_mu**0.5)/(self.F_c**2)*e*self.Ay_sqrta*np.sin(self.Ay_Ek)
...
#        Ay_M = Ay_M0 + ( (F_mu/((Ay_sqrta)**2)**3 )**0.5 + Ay_dn) * Ay_tk
    ...
    def get_sate_clock_error(self,Ay_pseudo_range,af0,af1,af2,toc,F_time_chose_sec_int,F_time_chose_sec_decimal,F_gpsweektime_fst):
        '''
        此為原先上課版本
        ''' 
#        F = -4.442807633e-10
...
#        Ay_signal_transmission_time = Ay_recever_time - Ay_pseudo_range/self.F_c
    
        Ay_t = Ay_signal_transmission_time_total - toc 
    
#        print(Ay_t[6])
        for i in range(2):
            Ay_t -= af0 + af1*Ay_t+af2*(Ay_t**2)
          
#        print((af0 + af1*Ay_t+af2*(Ay_t**2))[6])
...
#        for I_time_chose in range(1):
            ...
            if len(np.where(Ay_pr_data[I_time_chose,:] != 0.)[0]) >= 4:    
                ...
                Ay_zk    (N,)
                '''
                Ay_delta_t_sv = Mobj_sate_cal.get_sate_clock_error(Ay_pseudo_range,af0,af1,af2,toc,F_time_chose_sec_int,F_time_chose_sec_decimal,F_gpsweektime_fst)
        #            print(Ay_delta_t_sv)    
        ...
        #            (Ay_xk,Ay_yk,Ay_zk) = Mobj_sate_cal.get_sate_position(M0,dn,e,sqrta,i0,omg0,w,odot,idot,
        #                                                    cuc,cus,crc,crs,cic,cis,toe,
        #                                                    F_time_chose_sec_total+F_gpsweektime_fst-Ay_delta_t_sv,Ay_pseudo_range)
                
                (Ay_xk,Ay_yk,Ay_zk,Ay_delta_t_sv) = Mobj_sate_cal.get_sate_position(M0,dn,e,sqrta,i0,omg0,w,odot,idot,
                                                        cuc,cus,crc,crs,cic,cis,toe,
                                                        F_time_chose_sec_int,F_time_chose_sec_decimal,
                                                        F_gpsweektime_fst,Ay_delta_t_sv,Ay_pseudo_range,
                                                        af0,af1,af2,toc)     
...
#    print("test = ez2do_every_thing(15,73,'sun1')")
    test = ez2do_every_thing(I_year,I_day,'woos',15.,If_ionofree=True,S_ionofree_model_type='C1P2')
    test_ENU = test.ENU()
    np.save(r'D:\Ddddd\python\2003\Odata\test\2003324data\woos_sin_{0:03d}_C1P2.npy'.format(I_day),test_ENU)

    test = ez2do_every_thing(I_year,I_day,'woos',15.,If_ionofree=True,S_ionofree_model_type='broadcast')
    test_ENU = test.ENU()
    np.save(r'D:\Ddddd\python\2003\Odata\test\2003324data\woos_sin_{0:03d}_broadcast.npy'.format(I_day),test_ENU)


    test = ez2do_every_thing(I_year,I_day,'woos',15.,If_ionofree=False)
    test_ENU = test.ENU()
    np.save(r'D:\Ddddd\python\2003\Odata\test\2003324data\woos_sin_{0:03d}_noionfree.npy'.format(I_day),test_ENU) 
