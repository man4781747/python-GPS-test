...
def GetSateInfo(Ay_NDataChose, Ay_PrChose, I_TimeInt, F_TimeDecimal, F_GPSWeek_Sec):
    Mobj_sate_cal = Satellite_Calculate(Ay_NDataChose)
    Ay_SateTimeDelay = Mobj_sate_cal.get_sate_clock_error(Ay_PrChose, I_TimeInt, F_TimeDecimal, F_GPSWeek_Sec)
    (Ay_xk,Ay_yk,Ay_zk,Ay_SateTimeDelay) = Mobj_sate_cal.get_sate_position(
                                                        I_TimeInt, F_TimeDecimal,
                                                        F_GPSWeek_Sec,Ay_SateTimeDelay,Ay_PrChose)    
...
#        print(get_sate_clock_error_fix[6])
    ...
    def GetSatePositionAndClockDelay(self,Ay_PrChose_C1,C_Time,F_GPSWeek_Sec):
        Ay_SateTimeDelay = self.get_sate_clock_error(Ay_PrChose_C1,C_Time.I_TimeInt,C_Time.F_TimeDecimal,F_GPSWeek_Sec)
        return(self.get_sate_position(C_Time.I_TimeInt,C_Time.F_TimeDecimal,
                          F_GPSWeek_Sec,Ay_SateTimeDelay,Ay_PrChose_C1))
